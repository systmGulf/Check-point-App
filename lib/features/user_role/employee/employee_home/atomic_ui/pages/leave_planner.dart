...
class LeavePlanner extends StatefulWidget {
  const LeavePlanner({super.key});

  @override
  State<LeavePlanner> createState() => _LeavePlannerState();
}

class _LeavePlannerState extends State<LeavePlanner> {
  ...
  validateAndSubmitLeaveRequest() {
    if (formKey.currentState!.validate()) {
      BlocProvider.of<LeaveApplicationCubit>(context)
          .sendRequestToSupervisor(type: "LeavePlanner");
    }
  }
}
