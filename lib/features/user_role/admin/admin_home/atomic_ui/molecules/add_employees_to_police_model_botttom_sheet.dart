      ...
      child: Container(
        ...
        child: Column(
          children: [
           ...
           icon:   Icon(Icons.close  ,color: ColorsManger.primaryColor,) 
                    ...
                    onSelectionChange: (selectedItems) {
                        context.read<ShiftsAndPolicesCubit>().employeesIds =
                          List<String>.generate(selectedItems.length,
                              ...
                              if(  context.read<ShiftsAndPolicesCubit>().employeesIds.contains(List<String>.generate(selectedItems.length,
                              (index) => selectedItems[index]))){
                                context.read<ShiftsAndPolicesCubit>().employeesIds.remove(List<String>.generate(selectedItems.length,
                              (index) => selectedItems[index]));
                              }
                    },
                  );
